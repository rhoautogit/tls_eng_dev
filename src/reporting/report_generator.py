            ...
            writer.writerow(
                {
                    ...
                    "tesseract_ocr_pct": f"{sc.get('tesseract_ocr', 0.0):.4f}",
...
<div class="contrib-legend">
  ...
  <span><span class="legend-dot" style="background:#9b59b6"></span> Tesseract OCR</span>
</div>"""
      ...
      <div class="two-col">
        ...
        <div>
          ...
          <table style="max-width:400px">
            ...
            <tr><td>Tesseract OCR</td><td>{_pct(sc.get('tesseract_ocr', 0.0))}</td></tr>
...
def write_html(doc: DocumentResult, out_path: Path, embed_images: bool = True) -> None:
    ...
    <div class="stat-grid">
      ...
      <div class="stat-box"><div class="value">{_pct(summary['pass_rate'])}</div>
    ...
    <table style="max-width:500px">
      ...
      <tr><td>Tesseract OCR</td><td>{_pct(tc.get('tesseract_ocr', 0.0))}</td></tr>
...
class ReportGenerator:
    ...
    def generate(self, doc: DocumentResult, pdf_stem: str) -> Dict[str, str]:
        ...
        """
        paths: Dict[str, str] = {}
        base = self._reports_dir / pdf_stem
